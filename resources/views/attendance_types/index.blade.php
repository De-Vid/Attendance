        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $setting->label }}</td>
                    <td>
                        <a href="{{ route('attendance_types.edit', $setting->id) }}" class="btn btn-outline-success btn-sm rounded-pill px-3 shadow-sm me-1">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content border-0 rounded-4 shadow">
                                    ...
                                    <div class="modal-footer border-0 justify-content-center pb-4">
                                        ...
                                        <form action="{{ route('attendance_types.destroy', $setting->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
